...
Using the two supplied classes `QueryBuilder` and `QueryParameter` it is easy to build complex DB queries as shown below. You can use these two simple classes in your own projects.
